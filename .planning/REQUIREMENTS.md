...
- [ ] **SKILL-04**: `legate init` also installs `~/.claude/commands/legate-update.md` — triggers `npm install -g legate` via bash tool then reminds user to restart Claude Code
